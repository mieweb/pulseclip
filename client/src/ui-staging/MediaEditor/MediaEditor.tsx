 ...
 *
 * Staged here in pulseclip for development; lifts verbatim into
 * ui/src/components (see mieui-plan.md).
 */
...
import { PLAYBACK_SPEEDS } from '../types/transcript';
    ...
    return (
      <div ref={ref} className={mediaEditorVariants({ splitLayout, className })}>
        ...
        <div className={`flex min-h-0 flex-1 flex-col ${splitLayout === 'vertical' ? 'md:w-1/2' : ''}`}>
          ...
          <div
            ref={contentRef}
            className={`min-h-0 flex-1 overflow-y-auto p-3 text-sm leading-7 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring ${
